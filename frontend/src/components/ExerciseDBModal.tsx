...
export default function ExerciseDBModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white/95 backdrop-blur-md rounded-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl border border-mermaid-aqua-200 animate-fade-in-up"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="sticky top-0 bg-white/95 backdrop-blur-md border-b border-mermaid-aqua-200 p-6 z-10">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h2 className="text-2xl font-bold text-mermaid-teal-900">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-10 rounded-lg border border-mermaid-aqua-200 bg-white text-mermaid-teal-900 placeholder-mermaid-teal-400 focus:outline-none focus:ring-2 focus:ring-mermaid-aqua-500 focus:border-transparent"
            />
            <svg
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {loading && (
            <div className="text-center py-12">
              <p className="text-mermaid-teal-700">Searching exercises...</p>
            </div>
          )}

          {!loading && searchQuery && results.length === 0 && !error && (
            <div className="text-center py-12">
              <p className="text-mermaid-teal-700">
            ...
            <div className="space-y-4">
              {results.map((exercise) => (
                <div
                  ...
                  className="bg-white border border-mermaid-aqua-200 rounded-lg p-4 hover:shadow-md transition-shadow"
                >
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-mermaid-teal-900 mb-2">
                        {exercise.name}
                      </h3>
                      <div className="flex flex-wrap gap-2 mb-3 text-sm">
                        {(exercise.bodyParts && exercise.bodyParts.length > 0) && (
                          <span className="px-2 py-1 bg-mermaid-aqua-100 text-mermaid-teal-700 rounded">
                        ...
                        {(exercise.targetMuscles && exercise.targetMuscles.length > 0) && (
                          <span className="px-2 py-1 bg-mermaid-purple-100 text-mermaid-purple-700 rounded">
                        ...
                        {(exercise.equipments && exercise.equipments.length > 0) && (
                          <span className="px-2 py-1 bg-mermaid-teal-100 text-mermaid-teal-700 rounded">
                        ...
                        {exercise.exerciseType && (
                          <span className="px-2 py-1 bg-mermaid-coral-100 text-mermaid-coral-700 rounded">
                            {exercise.exerciseType}
                          </span>
                        )}
                      ...
                      {exercise.description && (
                        <p className="text-sm text-mermaid-teal-600 mb-3 line-clamp-2">
                          {exercise.description}
                        </p>
                      )}
